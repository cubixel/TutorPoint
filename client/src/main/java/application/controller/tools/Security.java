...
public class Security {
    ...
    public static String hashPassword(String password){
        ...
        // *** NOTE ***
        // - Password should add salt to minimise collisions or remove identical hashes on commonly used passwords.
        // - Salt must be a unique fixed length string of random characters and stored along side the user's data on the server database.
